...
contract Tradeable is Token {
	...
	function Tradeable(uint256 _tokenPrice, uint256 _etherPrice) public {
  ...
  function tokenPriceInWei() public constant returns (uint256) {
	...
	function amountOfTokensToBuy(uint256 _valueInWei) public constant returns (uint256 amount) {
	...
	function valueOfTokensToSell(uint256 _amount) public constant returns (uint256 valueInWei) {
